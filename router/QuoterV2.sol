...
import '@sheepdex/core/contracts/lib/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, ISpeSwapCallback, PeripheryImmutableState {
    ...
    function swapCallback(
        ...
        ISpePool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISpePool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
